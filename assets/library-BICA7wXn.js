const k="c0fe092c4149192005601ffec65036a5",L="https://api.themoviedb.org/3",A=`${L}/trending/movie/day?api_key=${k}`,H=document.getElementById("hero"),F=document.getElementById("movie-title"),O=document.getElementById("movie-overview"),j=document.getElementById("movie-rating"),U=document.getElementById("hero-buttons"),z=document.getElementById("trailer-btn"),f=document.getElementById("load-more-btn"),b=document.getElementById("trailer-modal"),G=document.getElementById("close-modal"),_=document.getElementById("trailer-frame"),E=document.getElementById("library-list"),S=document.getElementById("empty-library"),i=document.getElementById("genre-filter");let p=0;const J=9;function C(e){const o=e/2;let t="";for(let n=1;n<=5;n++)o>=n?t+='<svg class="star-svg-full" width="20" height="20"><use href="../img/icon.svg#icon-full-star"></svg>':o>=n-.5?t+=`<svg class="star-svg-half" width="20" height="20" viewBox="0 0 32 32">
                    <path
                      fill="none"
                      stroke="#f87719"
