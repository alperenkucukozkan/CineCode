import{c as b}from"./api-W8kOuucx.js";import{Modal as v}from"./modal-B7i7SvVV.js";import"./vendor-B5Z-9nsW.js";const g=document.getElementById("library-list"),p=document.getElementById("empty-library"),s=document.getElementById("genre-filter"),o=document.getElementById("load-more-btn");let c={},d=[],l=0;const E=9;function k(r){const t=(Number(r)||0)/2;let e="";for(let n=1;n<=5;n++)t>=n?e+=`
...
//# sourceMappingURL=library-D43dnBex.js.map
