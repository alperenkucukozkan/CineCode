const v="c0fe092c4149192005601ffec65036a5",E="https://api.themoviedb.org/3",N=`${E}/trending/movie/day?api_key=${v}`,A=document.getElementById("hero"),C=document.getElementById("movie-title"),H=document.getElementById("movie-overview"),O=document.getElementById("movie-rating"),j=document.getElementById("hero-buttons"),U=document.getElementById("trailer-btn"),y=document.getElementById("load-more-btn"),m=document.getElementById("trailer-modal"),z=document.getElementById("close-modal"),I=document.getElementById("trailer-frame"),h=document.getElementById("library-list"),B=document.getElementById("empty-library"),i=document.getElementById("genre-filter");let p=0;const G=9;function S(e){const n=e/2;let t="";for(let r=1;r<=5;r++)n>=r?t+='<svg class="star-svg-full" width="20" height="20"><use href="../img/icon.svg#icon-full-star"></svg>':n>=r-.5?t+=`<svg class="star-svg-half" width="20" height="20" viewBox="0 0 32 32">
                    <path
                      fill="none"
                      stroke="#f87719"
